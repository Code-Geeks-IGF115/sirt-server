...
const { crearHistoriaDietetica,
  ...
  verHistoriaDietetica, editarHistoriaDietetica } = require(__dirname + '/controladores/fichaNutricion/HistoriaDieteticaControl.js');
...
app.route('/ficha/nutricion/consulta/historia-dietetica/')
  .post(bodyParser.json(), crearHistoriaDietetica);
...
app.route('/ficha/nutricion/consulta/historia-dietetica/:id/edit')
  .post(bodyParser.json(), editarHistoriaDietetica);
  app.route('/ficha/nutricion/consulta/historia-dietetica/:id')
    .get(bodyParser.json(),verHistoriaDietetica);
//Plan Alimenticio
